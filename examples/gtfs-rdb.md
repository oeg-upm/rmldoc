...
```bash
http://mapping.example.com/database_4
``` 
- **Subject**
```bash
...
```bash
http://mapping.example.com/database_12
``` 
- **Subject**
```bash
...
```bash
http://mapping.example.com/database_5
``` 
- **Subject**
```bash
...
```bash
http://mapping.example.com/database_6
``` 
- **Subject**
```bash
http://transport.linkeddata.es/madrid/metro/services/{service_id}
...
```bash
http://mapping.example.com/database_10
``` 
- **Subject**
```bash
...
```bash
http://mapping.example.com/database_2
``` 
- **Subject**
```bash
...
```bash
http://mapping.example.com/database_8
``` 
- **Subject**
```bash
...
```bash
http://mapping.example.com/database_1
``` 
- **Subject**
```bash
...
```bash
http://mapping.example.com/database_11
``` 
- **Subject**
```bash
...
```bash
http://mapping.example.com/database_9
``` 
- **Subject**
```bash
...
```bash
http://mapping.example.com/database_7
``` 
- **Subject**
```bash
...
```bash
http://mapping.example.com/database_0
``` 
- **Subject**
```bash
...
```bash
http://mapping.example.com/database_3
``` 
- **Subject**
```bash
